...
def geo(request):
	...
	return render(request, 'restful/geo.html', {
			'ip': geodata['ip'],
...
def github(request):
	...
	return render(request, 'restful/github.html', {'search_result':search_result})
...
def oxford(request):
	...
	if 'word' in request.GET:
		...
		form = DictionaryForm()
	return render(request, 'restful/oxford.html', {'form': form, 'search_result': search_result})
