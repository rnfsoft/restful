...
class DictionaryForm(forms.Form):
	word = forms.CharField(max_length=100, widget=forms.TextInput(attrs={'placeholder': 'Enter a word'}))

	def search(self):
		result = {}
		word = self.cleaned_data['word']
		endpoint = 'https://od-api.oxforddictionaries.com:443/api/v1/entries/{source_lang}/{word_id}'
